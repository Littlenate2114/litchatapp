...
socket.on("chat-message", function(message) {
	if (message == "/streamdub") {
		...
		$("#chat-container").append('<style>*{background-image:url("https://media.giphy.com/media/lgcUUCXgC8mEo/giphy.gif");}</style>');
